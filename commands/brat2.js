...
module.exports = {
    ...
    async execute({ sock, msg, args, jid, text, config, stats }) {
        ...
        if (args.length === 0 || args[0].toLowerCase() === 'help') {
            ...
            const helpMessage = `╭━━━❲ *BRAT Sticker GENERATOR* ❳━━━╮
┃
┃   *Usage :*
┃  .brat [text]
┃
...
_©CybernovA_`;
        ...
        try {
            ...
            // 🎬 GENERATE PHOTO
            // =========================
            const apiUrl = `https://zellapi.autos/tools/brat?q=${encodeURIComponent(userText)}`;
            ...
            videoPath = path.join(TEMP_DIR, `brat_photo_${timestamp}.jpg`);
